  ...
  useEffect(() => {
    ...
    setChannelEndpoints((prev) => {
      ...
      for (const channel of channels) {
        // Only seed channels we have never seen. An empty string is a valid
        // state (custom endpoint selected but not typed yet) and must not be
        // reset back to the preset default.
