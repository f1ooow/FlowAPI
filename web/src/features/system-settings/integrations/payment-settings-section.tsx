  ...
  return (
    <SettingsSection title={t('Payment Gateway')}>
        ...
        <Alert variant='destructive' className='mb-6'>
          ...
          <AlertDescription>
            <div className='space-y-3'>
              <p>
                {t(
                  'Payment, redemption codes, and invitation rewards are locked until the root administrator confirms the compliance terms.'
                )}
              </p>
      ...
      <RiskAcknowledgementDialog
        ...
        description={t(
          'This confirmation unlocks payment, redemption code, and invitation reward features. Please read the statements carefully.'
        )}
